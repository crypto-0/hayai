...
class QTitleNavbar(QFrame):
    ...
    def __init__(self,title,parent: Optional[QWidget] = None):
        ...
        self.leftNavButton.setIcon(QIcon("hayai/widgets/titlenavbar/assets/go-back.png"))
        ...
        self.righNavButton.setIcon(QIcon("hayai/widgets/titlenavbar/assets/go-forward.png"))
