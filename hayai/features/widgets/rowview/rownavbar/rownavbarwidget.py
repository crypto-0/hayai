...
class QRowNavbar(QFrame):
    ...
    def __init__(self,title,parent: Optional[QWidget] = None):
        ...
        self.leftNavButton.setIcon(QIcon("hayai/features/widgets/rowview/rownavbar/assets/go-back.png"))
        ...
        self.righNavButton.setIcon(QIcon("hayai/features/widgets/rowview/rownavbar/assets/go-forward.png"))
