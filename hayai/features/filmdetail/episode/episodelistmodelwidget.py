...
class EpisodeListModel(QAbstractListModel):
    ...
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        #self.defaultThumbnail: QIcon = QIcon("hayai/assets/imgs/thumbnail-default.jpg")
        self.defaultThumbnail: QIcon = QIcon("hayai/assets/imgs/thumbnail-default-grey.png")
