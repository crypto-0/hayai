...
from hayai.widgets.titlebar.titlebarbuttons.titlebarbuttons import SvgTitleBarButton
...
class QStandardTitleBar(QTitleBar):
    ...
    def __init__(self, parent):
        super().__init__(parent)
        # add window icon
        self.backButton: PngTitleBarButton = PngTitleBarButton("hayai/widgets/titlebar/assets/left.png",self)
