...
from PyQt6.QtWidgets import QAbstractButton, QButtonGroup, QGroupBox, QSizePolicy, QVBoxLayout, QWidget
...
class QNav(QGroupBox):
    ...
    def __init__(self,title:str,navLinks: List[str],parent: Optional[QWidget] = None):
        ...
        navLayout.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignTop) 
    ...
    def createNavButton(self,navLink: str):
            iconLocation = f"hayai/features/widgets/sidebar/assets/icons/{navLink}.png"
